...
- `Theme/Color+Theme.swift` — every colour, type style and metric in the app. Dynamic light/dark tokens, no asset catalog. This is the file to reconcile against `docs/theme.md` when Akshat's session publishes it.
